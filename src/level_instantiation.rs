...
/// Handles creation of levels and objects. Split into the following
/// sub-plugins:
/// - [`map::plugin`] handles loading of level files and orchestrates the
///   spawning of the objects therein.
